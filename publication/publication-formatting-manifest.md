...
| 05 | STEPS TO FREEDOM | `chapters/05_StepsToFreedom.md` | 9 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 06 | STARTING MONDAY | `chapters/06_StartingMonday.md` | 7 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 08 | CHICKEN AND MASH | `chapters/08_Chicken&Mash.md` | 4 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 09 | EARNING THE RIGHT | `chapters/09_EarningTheRight.md` | 5 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 10 | SET UP YOUR STATION | `chapters/10_SetUpYourStation.md` | 2 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 11 | FAT SAM | `chapters/11_FatSam.md` | 4 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
...
| 14 | HOT TRAYS DON'T ANNOUNCE THEMSELVES | `chapters/14_HotTrays.md` | 3 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 15 | THE ONES WHO STAY | `chapters/15_TheOnesWhoStay.md` | 5 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 16 | IF YOU DIDN'T TASTE IT, IT ISN'T YOURS | `chapters/16_TasteIt.md` | 4 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 17 | TWO GLASSES ON THE PASS | `chapters/17_TwoGlasses.md` | 4 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 18 | PRODUCTION KITCHEN | `chapters/18_ProductionKitchen.md` | 8 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 19 | THE BASELINE | `chapters/19_TheBaseline.md` | 5 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 20 | COAST OR CLIMB | `chapters/20_CoastOrClimb.md` | 10 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
| 21 | GOOSE & GANDER | `chapters/21_Goose&Gander.md` | 3 | PASS | PASS | PASS; font=PASS | PASS_100_PERCENT |  |
