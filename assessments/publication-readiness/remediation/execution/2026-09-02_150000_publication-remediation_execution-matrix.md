...
| 45 | 5 | REM-007 | LOW | P4 | `chapters/13_HotTrays.md` | bundle with Batch 2 pass on ch.13 (run after Batch 2 closes) | Punctuation fix | Diff shows only the mark changed | PLANNED |
